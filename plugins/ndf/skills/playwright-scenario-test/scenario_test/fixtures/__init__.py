"""playwright-scenario-test pytest fixtures (v0.3.0+)。
...
- ``evidence`` (Phase 2 以降): ``ndf_evidence`` (HAR / trace / console listeners)
- ``a11y``    (Phase 2 以降): autouse hook で page_role marker に応じ axe-core
- ``cwv``     (Phase 2 以降): autouse hook で page_role marker に応じ CWV 計測
